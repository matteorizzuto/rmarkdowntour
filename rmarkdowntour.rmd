...
# Roadmap {data-background=images/Rome_Via.jpg data-background-size=cover}
...
# Philosophy {data-background=images/Sanzio_01_Pythagoras.jpg data-background-size=cover}
...
knitr::include_graphics("images/writing1.png")
```

## What is writing?
```{r echo=FALSE,fig.align='center',out.width="75%"}
knitr::include_graphics("images/writing2.png")
```

## What is writing?
```{r echo=FALSE,fig.align='center',out.width="75%"}
knitr::include_graphics("images/writing3.png")
```
...
knitr::include_graphics("images/mddocx.png")
```
...
knitr::include_graphics("images/thatsall.gif")
```
...
knitr::include_graphics("images/patronus.gif")
```
...
```{r echo=FALSE,fig.align='center',out.width="75%"}
knitr::include_graphics("images/letsdothis.gif")
```
...
knitr::include_graphics("images/cuetomusic.gif")
```
