...
> **Important!** Research shows that coding with music is 100% 
more enjoyable. It also helps a lot to have some to muffle your 
screams of rage when R Markdown will give you the (inevitable) 
middle finger...

```{r rmarkdown-music, echo=FALSE,fig.align='center'}
knitr::include_graphics("cuetomusic.gif")
```

> Be a good coder, be like Deadpool ;) 
Ok, now we're all set to dive into the magical word of...
